      ...
      <div className="max-w-4xl mx-auto pb-12">
        ...
        <div className="mb-8 mt-4">
          ...
          <p className="text-base-content/70">
            Document your insights and share your life experiences with the
            community.
          </p>
        </div>
          ...
          <div className="card-body p-6 md:p-8">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="form-control w-full">
                ...
                <textarea
                  placeholder="Share your experience, what you learned, and how it changed your perspective..."
              ...
              <div className="form-control w-full">
                ...
                <label className="label">
                  <span className="label-text-alt text-base-content/50">
                    Paste a direct image link to be featured at the top of your
                    lesson.
                  </span>
                </label>
              </div>
              ...
              <div className="form-control mt-8 pt-6 border-t border-base-200">
                <button
                  type="submit"
                  className="btn btn-primary w-full sm:w-auto sm:px-12 ml-auto shadow-lg"
